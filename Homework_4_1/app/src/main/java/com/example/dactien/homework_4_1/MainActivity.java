...
public class MainActivity extends AppCompatActivity {
    ...
    ExpandableListView lvDsDiaDiem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addControls();
        lvDsDiaDiem.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            int previousGroup = -1;

            @Override
            public void onGroupExpand(int groupPosition) {
                if(groupPosition != previousGroup)
                    lvDsDiaDiem.collapseGroup(previousGroup);
    ...
    private void addControls() {
        ...
        myAdapter = new MyAdapter(this, listDiaDiem);
        lvDsDiaDiem.setAdapter(myAdapter);
    }
}
